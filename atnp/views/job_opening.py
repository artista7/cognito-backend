...
class JobOpeningViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if student_id:
            ...
            drive_ids = [i.drive.id for i in StudentInDrive.objects.filter(student_id=student_id)]
            ...
            queryset = queryset.filter(companyInDrive__drive__college_id=college_id)
        else:
            queryset = []
        return queryset
